...
function isOffline(err: unknown): boolean {
  return (err as { kind?: string })?.kind === 'network';
}
...
export const mockThread: Record<string, ChatMessage[]> = {
  'conv-1': [
...
export function mockSendMessage(conversationId: string, text: string): ChatMessage {
  ...
  const thread = mockThread[conversationId];
  if (thread) thread.push(message);
  else mockThread[conversationId] = [message];
...
export async function fetchConversations(): Promise<ConversationSummary[]> {
  try {
    return await request('/api/v1/messages/conversations');
  } catch (err) {
    if (isOffline(err)) return mockConversations;
    throw err;
  }
}
...
export async function fetchMessages(conversationId: string): Promise<ChatMessage[]> {
  try {
    return await request(`/api/v1/messages/conversations/${conversationId}`);
  } catch (err) {
    if (isOffline(err)) return mockThread[conversationId] ?? [];
    throw err;
  }
}
...
export async function sendMessage(conversationId: string, text: string): Promise<ChatMessage> {
  try {
    ...
    if (isOffline(err)) return mockSendMessage(conversationId, text);
    throw err;
  }
}
...
export async function fetchPrescriptions(): Promise<Prescription[]> {
  try {
    return await request('/api/v1/prescriptions');
  } catch (err) {
    if (isOffline(err)) return mockPrescriptions;
    throw err;
  }
}
...
export async function fetchReports(): Promise<Report[]> {
  try {
    return await request('/api/v1/reports');
  } catch (err) {
    if (isOffline(err)) return mockReports;
    throw err;
  }
}
...
export const mockConsultSessions: TeleconsultSession[] = [
...
export async function fetchConsultSessions(): Promise<TeleconsultSession[]> {
  try {
    return await request('/api/v1/consultations');
  } catch (err) {
    if (isOffline(err)) return mockConsultSessions;
    throw err;
  }
}
...
export const mockFieldPatients: FieldPatient[] = [
...
export const mockTriageNotes: TriageNote[] = [
...
export const mockWorkerReferrals: WorkerReferral[] = [
...
export const mockWorkerFollowUps: WorkerFollowUp[] = [
...
export async function fetchWorkerOverview(): Promise<WorkerStats> {
  try {
    return await request('/api/v1/worker/overview');
  } catch (err) {
    if (isOffline(err)) return mockWorkerStats;
    throw err;
  }
}

export async function fetchWorkerPatients(): Promise<FieldPatient[]> {
  try {
    return await request('/api/v1/worker/patients');
  } catch (err) {
    if (isOffline(err)) return mockFieldPatients;
    throw err;
  }
}

export async function fetchTriageNotes(): Promise<TriageNote[]> {
  try {
    return await request('/api/v1/worker/triage');
  } catch (err) {
    if (isOffline(err)) return mockTriageNotes;
    throw err;
  }
}

export async function fetchWorkerReferrals(): Promise<WorkerReferral[]> {
  try {
    return await request('/api/v1/worker/referrals');
  } catch (err) {
    if (isOffline(err)) return mockWorkerReferrals;
    throw err;
  }
}

export async function fetchWorkerFollowUps(): Promise<WorkerFollowUp[]> {
  try {
    return await request('/api/v1/worker/followups');
  } catch (err) {
    if (isOffline(err)) return mockWorkerFollowUps;
    throw err;
  }
}
...
export const mockPhcStats: PhcStats = {
  queueCount: 9,
  patientsToday: 34,
  bedsOccupied: 5,
  bedsTotal: 10,
...
export const mockPhcPatients: PhcPatient[] = [
...
export const mockPhcReferrals: PhcReferral[] = [
...
export async function fetchPhcOverview(): Promise<PhcStats> {
  try {
    return await request('/api/v1/phc/overview');
  } catch (err) {
    if (isOffline(err)) return mockPhcStats;
    throw err;
  }
}

export async function fetchPhcQueue(): Promise<QueueEntry[]> {
  try {
    return await request('/api/v1/phc/queue');
  } catch (err) {
    if (isOffline(err)) return mockQueue;
    throw err;
  }
}

export async function fetchPhcPatients(): Promise<PhcPatient[]> {
  try {
    return await request('/api/v1/phc/patients');
  } catch (err) {
    if (isOffline(err)) return mockPhcPatients;
    throw err;
  }
}

export async function fetchPhcReferrals(): Promise<PhcReferral[]> {
  try {
    return await request('/api/v1/phc/referrals');
  } catch (err) {
    if (isOffline(err)) return mockPhcReferrals;
    throw err;
  }
}

export async function fetchPhcMedicines(): Promise<Medicine[]> {
  try {
    return await request('/api/v1/phc/medicines');
  } catch (err) {
    if (isOffline(err)) return mockMedicines;
    throw err;
  }
}

export async function fetchPhcDiagnostics(): Promise<DiagnosticItem[]> {
  try {
    return await request('/api/v1/phc/diagnostics');
  } catch (err) {
    if (isOffline(err)) return mockDiagnostics;
    throw err;
  }
}
...
export const mockAnalytics: AnalyticsRow[] = [
...
export const mockAdminFacilities: AdminFacility[] = [
...
export const mockAdminReferralCases: AdminReferralCase[] = [
...
export async function fetchAdminOverview(): Promise<AdminStats> {
  try {
    ...
    if (isOffline(err)) return mockAdminStats;
    throw err;
  }
}
...
export async function fetchAnalytics(): Promise<AnalyticsRow[]> {
  try {
    ...
    if (isOffline(err)) return mockAnalytics;
    throw err;
  }
}

export async function fetchAdminFacilities(): Promise<AdminFacility[]> {
  try {
    return await request('/api/v1/admin/facilities');
  } catch (err) {
    if (isOffline(err)) return mockAdminFacilities;
    throw err;
  }
}

export async function fetchAdminReferralCases(): Promise<AdminReferralCase[]> {
  try {
    return await request('/api/v1/admin/referrals');
  } catch (err) {
    if (isOffline(err)) return mockAdminReferralCases;
    throw err;
  }
}

export async function fetchAdminReportsList(): Promise<AdminReportItem[]> {
  try {
    return await request('/api/v1/admin/reports');
  } catch (err) {
    if (isOffline(err)) return mockAdminReports;
    throw err;
  }
}
...
export async function fetchAdminSettings(): Promise<AdminSetting[]> {
  try {
    return await request('/api/v1/admin/settings');
  } catch (err) {
    if (isOffline(err)) return mockAdminSettings;
    throw err;
  }
}